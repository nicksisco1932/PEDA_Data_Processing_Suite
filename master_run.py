#!/usr/bin/env python3
r"""
master_run.py  (v2.3.3-compat+autoid+ascii)
...
- Calls structure_guard.py --fix at the end to enforce final layout
- ASCII-only logs (->) to avoid Windows cp1252 encode errors
"""
